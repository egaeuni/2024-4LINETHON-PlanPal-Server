...
from .views.MarkPromiseView import MarkPromiseView
...
urlpatterns = [
    ...
    path('promise/<str:my_username>/<str:target_username>/', GETPromiseByUsername.as_view(), name='promise-list-by-username'),
    ...
    path('promise/mark/<str:username>/<int:promise_id>/', MarkPromiseView.as_view(), name='promise-mark'),
]
